...
@section('title')
{{ $tag->name  }}
@endsection              {{-- style="background-image: linear-gradient(-225deg, #5D9FFF 0%, #B8DCFF 48%, #6BBBFF 100%); --}}

@section('header')
  <!-- Header -->
  <header class="header text-center text-white"   style="background-image: url({{ asset('img/header1.jpg') }})";>
    <div class="container">
